...
int main() {
    ...
    printf("This shell also follows my initial diagram made.\n");
    printf("To exit the shell, simply type 'exit'.\n");
    ...
    while (1) {
        ...
        if (strncmp(input, "cd ", 3) == 0) {
            //take the directory path after "cd " (after 3 indexes)
            char *directory = input + 3;
            
            //usse chdir to change to the specified directory
